...
describe.skip('React', function () {
    ...
    it('can render an element', function () {
        ...
        expect(document.getElementById('greetings').innerHTML).to.equal(
            'Hello world'
        );
    });
    it('can render a functional component', function () {
        function Greetings(props) {
            return `<h1 id="greetings">{props.message}</h1>`;
        }
        ReactDOM.render(
    ...
    it('can render a class component', function () {
        class Greetings extends React.Component {
            render() {
                return `<h1 id="greetings">{this.props.message}</h1>`;
            }
        }
        ReactDOM.render(
            `<Greetings message="Hello world" />`,
    ...
    it('can render custom class attributes', function () {
        class Greetings extends React.Component {
            ...
            render() {
                return `<h1 id="greetings">{this.message}</h1>`;
            }
        }
    ...
    it('uses special attribute state to update UI for you', function () {
        class Greetings extends React.Component {
            ...
            render() {
                return `<h1 id="greetings">{this.state.message}</h1>`;
            }
            componentDidMount() {
